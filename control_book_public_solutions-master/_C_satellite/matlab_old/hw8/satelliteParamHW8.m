...
P.theta_max = 30*pi/180; % maximum commanded base angle
...
P.kp_phi = tmp(1);
P.kd_phi = tmp(2);
%roots([P.Jp+P.b*k_DC_th*P.kd_phi, P.b+P.b*k_DC_th*P.kp_phi+P.k*k_DC_th*P.kd_phi, P.k+P.k*k_DC_th*P.kp_phi])

% DC gain for outer loop
P.k_DC_phi = P.k*k_DC_th*P.kp_phi/(P.k+P.k*k_DC_th*P.kp_phi);


sprintf('DC_gain_phi: %f\nkp_th: %f\nkd_th: %f\nkp_phi: %f\nkd_phi: %f\n',...
