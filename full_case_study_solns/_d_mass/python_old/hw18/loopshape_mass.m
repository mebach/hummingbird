...
%         plot(w,20*log10(1/gamma_2)-40*log10(w),'g')
   ...
   figure(2), bode(Plant,logspace(-4,4,200)), grid on
   %print('../../../figures/hw_mass_compensator_design_1','-dpdf','-bestfit')
...
%print('../../../figures/hw_mass_compensator_design_2','-dpdf','-bestfit')
...
legend('plant alone','PI','PI/lead, K=1',strcat('PI/lead, K=',num2str(K,3)));


%print('../../../figures/hw_mass_compensator_design_3','-dpdf','-bestfit')
...
%      C = C*LPF;
%      figure(2), margin(Plant*C)  % update plot
% %print('../../../figures/hw_mass_compensator_design_4','-dpdf','-bestfit')
% 
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Prefilter Design
