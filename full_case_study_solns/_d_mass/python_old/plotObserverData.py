...
class plotObserverData:
    ...
    def updatePlots(self, t, x, x_hat):
        ...
        self.z_dot_history.append(x[1])
        self.z_hat_history.append(x_hat[0])
        self.z_hat_dot_history.append(x_hat[1])

        # update the plots with associated histories
        self.handle[0].updatePlot(self.time_history, [self.z_history, self.z_hat_history])
        self.handle[1].updatePlot(self.time_history, [self.z_dot_history, self.z_hat_dot_history])
