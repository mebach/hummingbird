...
%         plot(w,20*log10(1/gamma_2)-40*log10(w),'g')
  ...
  figure(5), bode(Plant), grid on
 %print('../../../figures/hw_ballbeam_compensator_out_design_1','-dpdf','-bestfit')
...
% proportional control: change cross over frequency
     ...
     %print('../../../figures/hw_ballbeam_compensator_out_design_2','-dpdf','-bestfit')
...
% integral control: increase steady state tracking and dist rejection
     ...
     C = C*Integrator;
     figure(5), margin(Plant*C),  % update plot
     %print('../../../figures/hw_ballbeam_compensator_out_design_3','-dpdf','-bestfit')
...
% phase lead: increase PM (stability)
    ...
    C = C*Lead;
    figure(5), margin(Plant*C),  % update plot
    %print('../../../figures/hw_ballbeam_compensator_out_design_4','-dpdf','-bestfit')
...
% low pass filter: decrease gain at high frequency (noise)
     ...
     C = C*LPF;
     figure(5), margin(Plant*C),  % update plot
     %print('../../../figures/hw_ballbeam_compensator_out_design_5','-dpdf','-bestfit')
...
%     print('../../../figures/hw_ballbeam_compensator_out_design_6','-dpdf','-bestfit')
