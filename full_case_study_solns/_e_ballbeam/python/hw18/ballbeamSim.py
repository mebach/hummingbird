...
reference = signalGenerator(amplitude=0.125, y_offset=0.25, frequency=0.04)
disturbance = signalGenerator(amplitude=0.0)
noise_z = signalGenerator(amplitude=0.0)
noise_th = signalGenerator(amplitude=0.0)
...
while t < P.t_end:  # main simulation loop
    ...
    plt.pause(0.0001)  # the pause causes the figure to be displayed during the simulationw
