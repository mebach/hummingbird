function out=ballbeam_ctrl(in,P)
    ...
    for i=1:N
        xhat = xhat + ...
            P.Ts/N*(P.A*(xhat-x_e)+P.B*(F-F_e+dhat)...
                         +P.L*([theta_m;z_m]-P.C*xhat));
        dhat = dhat + P.Ts/N*P.Ld*([theta_m;z_m]-P.C*xhat);
    end
    zhat = xhat(2);
    ...
    F_unsat = F_e -P.K*(xhat-x_e) - P.ki*integrator - dhat;
    ...
    xhat2 = [xhat(2); xhat(1); xhat(4); xhat(3)];
    out = [F; xhat2];
