...
%         plot(w,20*log10(1/gamma_2)-40*log10(w),'g')
  ...
  %print('../../../figures/hw_ballbeam_compensator_in_design_1','-dpdf','-bestfit')
...
% proportional control: change cross over frequency
     ...
     %print('../../../figures/hw_ballbeam_compensator_in_design_2','-dpdf','-bestfit')
...
%      k_I = 1; % frequency at which integral action ends
...
% phase lead: increase PM (stability)
    ...
    C = C*Lead;
    figure(2), margin(Plant*C),  % update plot
    %print('../../../figures/hw_ballbeam_compensator_in_design_3','-dpdf','-bestfit')
...
% low pass filter: decrease gain at high frequency (noise)
     ...
     C = C*LPF;
     figure(2), margin(Plant*C),  % update plot
     %print('../../../figures/hw_ballbeam_compensator_in_design_4','-dpdf','-bestfit')
...
%     print('../../../figures/hw_ballbeam_compensator_in_design_5','-dpdf','-bestfit')
